...
public class UserService {
    ...
    public UserService(UserRepository repo, JwtService jwt, PasswordEncoder encoder) {
        this.repo = repo;
        this.jwt = jwt;
    ...
    public String register(User u) {
        ...
        u.setRole(Roles.USER); // ✅ always force ROLE_USER, ignore client input
    ...
    public Optional<User> byPhone(String phone)  { return repo.findByPhone(phone); }
